...
class Player(object):
    ...
    def take_turn(self):
        ...
        self.current_position = floor((last_position + roll_total)%40) #Calculates position after rolling dice, considering the board "loop"
        ...
        if self.doubles_count == 3 or special_condition:
            ...
            if special_condition:
                ...
                self.landed_spaces.append(10.5)
...
counter=collections.Counter(total_landed_spaces)
print(counter)
